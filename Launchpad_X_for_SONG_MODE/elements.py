...
class Elements(LaunchpadElements):
    ...
    def __init__(self, skin=None, *a, **k):
        ...
        self.button_fader_color_elements = ButtonMatrixElement(rows=[
         self.button_fader_color_elements_raw], name='Button_Fader_Color_Elements')
        self.note_layout_switch = SysexElement(name='Note_Layout_Switch', send_message_generator=lambda v: sysex.STD_MSG_HEADER + (
