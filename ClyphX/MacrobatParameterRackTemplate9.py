...
class MacrobatParameterRackTemplate(ControlSurfaceComponent):
    ...
    def macro_changed(self, index):
        ...
        if self._param_macros.__contains__(index) and self._param_macros[index][0] and self._param_macros[index][1]:
    ...
    def update_param(self, arg=None):
        ...
        if self._param_macros.__contains__(self._update_param):
    ...
    def update_macro(self, arg=None):
        ...
        if self._param_macros.__contains__(self._update_macro):
    ...
    def get_initial_value(self, arg=None):
        ...
        for index in range(1,9):
            if self._param_macros.__contains__(index):
