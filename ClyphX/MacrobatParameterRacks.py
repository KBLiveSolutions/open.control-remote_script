...
class MacrobatLearnRack(MacrobatParameterRackTemplate):
    ...
    def setup_device(self, rack):
        ...
        if LAST_PARAM and LAST_PARAM.__contains__(0):
            param = LAST_PARAM[0]
        ...
        if self._drum_rack:
            ...
            for index in range(1,9):
                ...
                if macro.is_enabled:
                    ...
                    if self._drum_rack['devs_by_index'].__contains__(drum_name):
                        drum_to_edit = self._drum_rack['devs_by_index'][drum_name]
                    elif self._drum_rack['devs_by_name'].__contains__(drum_name):
                        drum_to_edit = self._drum_rack['devs_by_name'][drum_name]
                    if drum_to_edit.__contains__(param_name):
        ...
        if self._drum_rack:
            ...
            for index in range(1,9):
                ...
                if macro.is_enabled:
                    ...
                    if drum_to_edit.__contains__(name):
